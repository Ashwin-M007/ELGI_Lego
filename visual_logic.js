 ...
 * Thu Apr 11 2024 13:10:19 GMT+0530 (India Standard Time)
...
var x, floorlist, j, k, i, newpiece;
...
setHTMLElemStyle('width', '50px', 'redb', false);
...
eventHTMLElem('click', 'redb', false, function(event) {
  ...
  createPhysicsBody('DYNAMIC', 'Cube', 'BOX', 1);
});
registerOnDrag('Cube', false, [0,1,2], function() {}, function() {
  dragMove('Cube', 'XYZ', '|^_NIRe3t+f}s?~!@8U8', '[I%.I2}c[0I@0A*9W}S{');
}, function() {}, '[I%.I2}c[0I@0A*9W}S{');
...
eventHTMLElem('click', 'yellowb', false, function(event) {
  ...
  createPhysicsBody('DYNAMIC', 'Cube.001', 'BOX', 1);
});
registerOnDrag(cloneObject('Cube.001'), false, [0,1,2], function() {}, function() {
  dragMove('Cube.001', 'XYZ', 'o;}qiopl!SJ.lOS-W3w=', 'eC6hTwHwHpbLbpSZp*t)');
}, function() {}, 'eC6hTwHwHpbLbpSZp*t)');

eventHTMLElem('click', 'greenb', false, function(event) {
  changeVis(cloneObject('Cube.002'), true);
  createPhysicsBody('DYNAMIC', cloneObject('Cube.002'), 'MESH', 1);
});
registerOnDrag('Cube.002', false, [0,1,2], function() {}, function() {
  dragMove('Cube.002', 'XYZ', 'Fag:*b5F5QDy!]%pc9fv', '1|8@OsQL]^|iQrp-L$`l');
}, function() {}, '1|8@OsQL]^|iQrp-L$`l');
