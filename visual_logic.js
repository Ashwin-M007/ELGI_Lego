 ...
 * Tue Apr 16 2024 16:21:22 GMT+0530 (India Standard Time)
...
var piece_dict, x, floorlist, j, k, newpiece, i;
...
function drag_move2(x) {
  registerOnDrag(x, false, [0], function() {}, function() {
    dragMove(x, 'XYZ', 'ozL?($sMV9uRU.Tf~9sS', 'y%BJLVAf|Y#%*V5x`iH8');
  }, function() {
    dictSet(piece_dict, x, getObjTransform(x, false, 'position', 'xyz'));
    console.log(dictGet(piece_dict, x));
    console.log(piece_dict);
    console.log('updated');
  }, 'y%BJLVAf|Y#%*V5x`iH8');
}
...
function drag_move(x) {
  registerOnDrag(x, false, [0,1,2], function() {
    ...
    dragMove(x, 'XYZ', 'WQa+e5GjeA?GY:Gxq{H5', 'lq1tlay8+)K,1mg1wt8U');
  }, function() {
    createPhysicsBody('DYNAMIC', x, 'MESH', 1);
  }, 'lq1tlay8+)K,1mg1wt8U');
}
...
eventHTMLElem('click', 'yellowb', false, function(event) {
  changeVis('Scene', false);
  newpiece = cloneObject('Cube.001');
  changeVis(newpiece, true);
  drag_move(newpiece);
});
eventHTMLElem('click', 'greenb', false, function(event) {
  changeVis('Scene', false);
  newpiece = cloneObject('Cube.002');
  changeVis(newpiece, true);
  drag_move(newpiece);
});
...
eventHTMLElem('click', 'yellowb', false, function(event) {
  ...
  createPhysicsBody('KINEMATIC', cloneObject('Cube.001'), 'MESH', 0);
  registerOnDrag(cloneObject('Cube.001'), false, [0,1,2], function() {}, function() {
    createPhysicsBody('KINEMATIC', cloneObject('Cube.001'), 'MESH', 0);
    dragMove(cloneObject('Cube.001'), 'XYZ', '=|6}38G!U8XY/Jw(CCCO', ':MpuzN~6SkUF]kn*pF|I');
  }, function() {}, ':MpuzN~6SkUF]kn*pF|I');
});
...
eventHTMLElem('click', 'yellowb', false, function(event) {
  ...
  registerOnDrag('Cube.001', false, [0,1,2], function() {}, function() {
    createPhysicsBody('KINEMATIC', 'Cube.001', 'MESH', 0);
    dragMove('Cube.001', 'XYZ', 'adAn;BB:aUs)N^Rs+0{l', 'l(5N$xe$@Xc.C-dVCXh;');
  }, function() {}, 'l(5N$xe$@Xc.C-dVCXh;');
});
...
eventHTMLElem('click', 'redb', false, function(event) {
  ...
  registerOnDrag('Cube', false, [0,1,2], function() {}, function() {
    createPhysicsBody('KINEMATIC', 'Cube', 'MESH', 0);
    dragMove('Cube', 'XYZ', 'W.d~G.B{Ff4gFda`Re.h', 'qokH/WJ_:p(^7O9/7^`;');
  }, function() {}, 'qokH/WJ_:p(^7O9/7^`;');
});
...
eventHTMLElem('click', 'greenb', false, function(event) {
  ...
  registerOnDrag('Cube.002', false, [0,1,2], function() {}, function() {
    createPhysicsBody('KINEMATIC', 'Cube.002', 'MESH', 0);
    dragMove('Cube.002', 'XYZ', 'Aly=|[H$A]=z#}:2aoxe', '$)1jW*ADyt[,`LS:.fCP');
  }, function() {}, '$)1jW*ADyt[,`LS:.fCP');
});
