 ...
 * Wed Apr 17 2024 17:20:12 GMT+0530 (India Standard Time)
...
var a, locr, c, floorlist, j, k, b, i, newpiece;
...
function drag_move(a) {
  ...
  registerOnDrag(a, false, [0,1,2], function() {}, function() {
    ...
    dictSet(locr, a, getObjTransform(a, false, 'position', 'xyz'));
  }, 'lq1tlay8+)K,1mg1wt8U');
  console.log(locr);
}
...
setHTMLElemStyle('width', '100px', 'save', false);
...
eventHTMLElem('click', 'yellowb', false, function(event) {
  ...
  createPhysicsBody('STATIC', a, 'MESH', 0);
...
eventHTMLElem('click', 'redb', false, function(event) {
  ...
  changeVis('Cube', true);
  createPhysicsBody('KINEMATIC', b, 'MESH', 0);
  j = (typeof j == 'number' ? j : 0) + 0;
  drag_move(b);
});
...
eventHTMLElem('click', 'greenb', false, function(event) {
  ...
  createPhysicsBody('DYNAMIC', c, 'MESH', 1);
  j = (typeof j == 'number' ? j : 0) + 0;
  drag_move(c);
});
